...
const mcpApps = [
  {
    ...
    status: 'Live',
    link: 'https://cost-coach.us-west.pmcp.run/landing',
            ...
            >
              <div className="glass-card p-8 h-full flex flex-col border-t-2 border-t-transparent hover:border-t-white/30 transition-all duration-300 relative overflow-hidden">
                ...
                <div className="flex justify-between items-start mb-6 z-10">
                  ...
                  <span className={`text-xs font-mono px-3 py-1 rounded-full text-black font-semibold ${
                    app.status === 'Live' ? 'bg-lcars-orange' : 
